...
const HomeHeader = ({onSearch}:{onSearch: (text: string) =>void}) => {
  return (
    <View style={{
      ...
      <View style={{
        ...
        <View style={{width:45,height:45}}>
          ...
          />
          <Image
            source={assets.badge} resizeMode='contain' style={{position:'absolute',width:15,height:15,bottom:0,right:0}}
          />
        </View>
      </View>
      ...
      <View style={{marginTop:SIZES.font}}>
        <View
        style={{width:'100%',borderRadius:SIZES.font,backgroundColor:COLORS.gray,flexDirection:'row',alignItems:'center',paddingHorizontal:SIZES.font,paddingVertical:SIZES.small-2}}>
